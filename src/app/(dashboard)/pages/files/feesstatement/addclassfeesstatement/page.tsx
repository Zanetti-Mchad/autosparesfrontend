...
const AddClassFeesStatement: React.FC = () => {   
  ...
  const handleSelectClass = (classId: string | number) => {
    ...
    router.push(`/pages/feesstatement/createfeesstatement?classId=${classId}`);
  };
  
  return (
    <ClassesList
      title="Select Class to Add Fees"
...
export default AddClassFeesStatement;