  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="container mx-auto py-10 px-4">
        ...
        <div className="bg-white p-5 rounded shadow max-w-6xl mx-auto">
          {/* Loading state */}
          {loading && (
