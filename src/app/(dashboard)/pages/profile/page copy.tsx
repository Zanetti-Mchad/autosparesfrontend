          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden">
            ...
            {activeTab === 'security' && (
              <div className="p-8 bg-gradient-to-br from-gray-50 to-blue-50">
                ...
                <form onSubmit={handlePasswordReset} className="space-y-6 max-w-2xl">
                  {passwordError && (
                    <div className="bg-red-50 border-l-4 border-red-500 text-red-700 p-4 rounded-lg">
                      <div className="flex">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="currentPassword" className="block text-sm font-semibold text-gray-700 mb-3 flex items-center">
                      <Key className="w-4 h-4 mr-2 text-blue-500" />
                      Current Password
                    </label>
                    <input
                      ...
                      className="w-full bg-white border-2 border-gray-200 rounded-2xl px-6 py-4 text-gray-800 font-medium focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition-all duration-300"
                      required
                  ...
                  <div className="space-y-2">
                    <label htmlFor="newPassword" className="block text-sm font-semibold text-gray-700 mb-3 flex items-center">
                      <Key className="w-4 h-4 mr-2 text-blue-500" />
                      New Password
                    </label>
                    <input
                  ...
                  <div className="pt-6">
                    <button
                      type="submit"
                      className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-4 px-8 rounded-2xl hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-3 font-semibold text-lg"
                    >
